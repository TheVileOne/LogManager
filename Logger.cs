...
namespace LogManager
{
    public class Logger : IDisposable
    {
        ...
        /// <summary>
        /// Logs data to the BaseLogger, and optionally the ActiveLogger if set
        /// </summary>
        /// <param name="data">A nullsafe object to be logged to file</param>
        /// <param name="level">An enum that describes the log content. Set to LogLevel.All to log to all sources, or optionally use LogAll()</param>
        ...
        /// <summary>
        /// Logs data to all registered LogModules as well as the Unity logger
        /// </summary>
        /// <param name="data">A nullsafe object to be logged to file</param>
        /// <param name="level">An enum that describes the log content</param>
        public void LogAll(object data, LogLevel level)
        {
            Debug.Log(data);
...
namespace LogUtils
{
    ...
    public class LogValidator
    {
        ...
        public LogValidator(string sourceLogPath, string destLogPath)
        {
            ...
            {
                SourceFile = new FileInfo(sourceLogPath);
                DestinationFile = new FileInfo(destLogPath);
            }
            */
        }
    ...
    public class LogFileSwitcher
    {
        ...
        public void SwitchPaths()
        {
            ...
            foreach (ValuePairToggle valuePair in PathStrings)
            {
                ...
                {
                    valuePair.Status = LogManager.Logger.MoveLog(path1, path2);
        ...
        public void SwitchToPath(string path)
        {
            ...
            {
                valuePair.Status = LogManager.Logger.MoveLog(valuePair.ActiveValue, path);
